        ...
        <div class="container">
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="w-fit flex flex-wrap gap-3">
                    <a href="#form" class="w-[53px] md:w-fit flex justify-center items-center rounded-lg leading-none shadow-md bg-orange text-white font-bold h-[53px] md:px-7">
...
<section class="banner bg-primary">
    <div class="container">
        <div class="w-full xl:w-5/12 py-20 md:pb-24 md:pt-32">
            ...
            <h1 class="text-5xl md:text-64 font-merge text-white leading-none pt-4">Your Fast, Local <span class="text-orange">South Melbourne</span> Plumber Experts</h1>
            ...
            <div class="w-full lg:w-1/2 md:px-3">
                <div class="h-full bg-primary rounded-10 flex flex-wrap overflow-clip text-white shadow-lg">
                    <div class="w-full md:w-5/12 grow py-10 px-3 md:p-14">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge py-5">Receive <br /><span class="text-orange">$100 Off</span></p>
            ...
            <div class="w-full lg:w-1/2 md:px-3">
                <div class="h-full bg-primary rounded-10 flex flex-wrap overflow-clip text-white shadow-lg">
                    <div class="w-full md:w-5/12 grow py-10 px-3 md:p-14">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge py-5">Receive <br /><span class="text-orange">$50 Off</span></p>
                        <p class="text-base md:text-lg md:pt-5">
            ...
            <div class="w-full md:w-1/2 lg:w-1/3 md:px-3">
                <div class="h-full bg-primary rounded-10 overflow-clip text-white shadow-lg">
                    <div class="w-full grow py-10 px-3 md:p-14 text-center">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge pt-5"><span class="text-orange">Free</span> Inspection</p>
                    </div>
                    <div class="w-full">
            ...
            <div class="w-full md:w-1/2 lg:w-1/3 md:px-3">
                <div class="h-full bg-primary rounded-10 overflow-clip text-white shadow-lg">
                    <div class="w-full grow py-10 px-3 md:p-14 text-center">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge pt-5">Receive <span class="text-orange">10% Off</span></p>
                    </div>
                    <div class="w-full">
            ...
            <div class="w-full md:w-2/3 lg:w-1/3 md:px-3">
                <div class="h-full bg-primary rounded-10 overflow-clip text-white shadow-lg">
                    <div class="w-full grow py-10 px-3 md:p-14 text-center">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge pt-5">Senior <span class="text-orange">Discounts</span></p>
                    </div>
                    <div class="w-full">
                ...
                <div class="flex flex-wrap justify-between items-center">
                    ...
                    <div class="w-fit">
                        <svg width="140" height="24" viewBox="0 0 140 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 0L15.8088 6.75757L23.4127 8.2918L18.1628 14.0024L19.0534 21.7082L12 18.48L4.94658 21.7082L5.83715 14.0024L0.587322 8.2918L8.19115 6.75757L12 0Z" fill="#FF9869" />
                            <path d="M41 0L44.8088 6.75757L52.4127 8.2918L47.1628 14.0024L48.0534 21.7082L41 18.48L33.9466 21.7082L34.8372 14.0024L29.5873 8.2918L37.1912 6.75757L41 0Z" fill="#FF9869" />
                            <path d="M70 0L73.8088 6.75757L81.4127 8.2918L76.1628 14.0024L77.0534 21.7082L70 18.48L62.9466 21.7082L63.8372 14.0024L58.5873 8.2918L66.1912 6.75757L70 0Z" fill="#FF9869" />
                            <path d="M99 0L102.809 6.75757L110.413 8.2918L105.163 14.0024L106.053 21.7082L99 18.48L91.9466 21.7082L92.8372 14.0024L87.5873 8.2918L95.1912 6.75757L99 0Z" fill="#FF9869" />
                            <path d="M128 0L131.809 6.75757L139.413 8.2918L134.163 14.0024L135.053 21.7082L128 18.48L120.947 21.7082L121.837 14.0024L116.587 8.2918L124.191 6.75757L128 0Z" fill="#FF9869" />
                        </svg>
                    </div>
                </div>
            ...
            <div class="w-full lg:w-5/12 lg:px-3">
                <div class="h-full bg-secondary rounded-10 py-10 px-5 md:p-14 text-center flex flex-col items-center justify-between gap-y-10 lg:gap-y-5">
                    <svg width="149" height="50" viewBox="0 0 149 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M16.7421 22.0786C16.7421 20.7791 16.8316 19.3403 17.3949 18.257C17.65 17.7664 17.9888 17.3799 18.4669 17.0999C18.9528 16.8153 19.7232 16.5591 20.9629 16.5591H37.846V12.0137H20.9629C19.0858 12.0137 17.486 12.4068 16.17 13.1775C14.8462 13.9526 13.9511 15.0271 13.3621 16.1599C12.2371 18.3234 12.1967 20.7807 12.1967 22.0786H11.2227V23.3773H17.7162V22.0786H16.7421Z" fill="#FF9869" />
                        <path d="M18.8535 37.6626H37.8462V33.1172H19.8602C20.0091 34.4131 19.9376 35.8988 19.1827 37.1766C19.081 37.3488 18.9711 37.5107 18.8535 37.6626Z" fill="#FF9869" />
                    ...
                    <p class="font-merge text-white text-4xl md:text-5xl capitalize"><span class="text-orange">24/7</span> general & emergency plumbing</p>
